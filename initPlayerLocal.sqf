...
if (player getVariable ["unitTeamRole", 0] == 1) then {
	...
	[4] call EMF_fnc_limitedRespawns; // Limit respawns to 4 for team 0
};

if ((player getVariable ["EMF_PlayerZeus", false]) && ((getPlayerUID player) != "76561198065818848")) then {
	["wrongZeus", false, 0.01, false] call BIS_fnc_endMission; // Kick player back to lobby if they are zeus and not Eric, change "76561198065818848" to your steamID
};
