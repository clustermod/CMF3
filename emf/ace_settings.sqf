...
], "Medical", "\z\ace\addons\medical_gui\data\categories\medication.paa", 0] call ace_arsenal_fnc_addRightPanelButton;
...
], "Radios", "\a3\Ui_f\data\GUI\Cfg\CommunicationMenu\call_ca.paa", 1] call ace_arsenal_fnc_addRightPanelButton;
