...
[LSTRING(respawn_module_category_displayname), LSTRING(setRespawns_module_displayname), _dialogFunction, "rsc\data\icon_module_setLives_ca.paa"] call zen_custom_modules_fnc_register;
