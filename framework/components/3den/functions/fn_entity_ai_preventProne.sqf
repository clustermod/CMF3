 ...
 *
 * Example:
 * [[_myToolsMenu], "Toggle preventProne"] call cmf_3den_fnc_ace_drag
 *
 * Public: No
 */
...
private _action = {
    ...
    private _enableCommand = "this setVariable ["QEGVAR(utility,preventProne_disable)", true]";
    private _disableCommand = "this setVariable ["QEGVAR(utility,preventProne_disable)", false]";
    ...
    private _statusText = format ["%1 preventProne for %2 object(s)", ["Enabled", "Disabled"] select _toggle, count _selections];
