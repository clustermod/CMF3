...
/* Default Vehicles */
private _defVehicles = ["RHS_MELB_AH6M"]; // "ALL" for all vehicles
private _defPylons = ["ALL"]; //  "ALL" for all pylons
private _defCamos = ["ALL"]; //  "ALL" for all camos
private _defComponents = ["ALL"]; //  "ALL" for all components
