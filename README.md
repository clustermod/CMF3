...
For a quick rundown on installing, configuring and running **CMF3** refer to the [Cluster Community Wiki](https://wiki.cluster-community.com/index.php/Category:Cluster_Community_Framework_(CMF3)).
