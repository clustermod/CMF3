...
if (typeName _thisTriggerList != "ARRAY") exitWith {["ERR", format['thisList must be type "ARRAY", type %1 supplied', (typeName _thisTriggerList)], "repairRearmTrigger", "gameplay"] call EMF_DEBUG; false;};
